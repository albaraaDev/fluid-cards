...
export default function StatsPage() {
  ...
  const advancedStats = useMemo(() => {
    ...
    words.forEach(word => {
      ...
      current.total++;
      if (word.correctCount >= 3) current.mastered++;
      if (word.nextReview <= Date.now()) current.needReview++;
    ...
    // إحصائيات الصعوبة
    const difficultyMap = new Map<string, { total: number; mastered: number }>();
    words.forEach(word => {
          ...
          <div className="bg-gray-800 rounded-2xl lg:rounded-3xl p-6 lg:p-8 border border-gray-700 mb-8 lg:mb-12">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center space-x-3">
                ...
                <h3 className="text-xl lg:text-2xl font-bold text-white">نظرة عامة على التقدم</h3>
              </div>
            ...
            <div className="grid grid-cols-3 gap-4 text-center">
              <div>
                ...
                <div className="text-sm lg:text-base text-gray-400">قيد التعلم</div>
              </div>
              <div>
              ...
              <div>
                ...
                <div className="text-sm lg:text-base text-gray-400">تحتاج مراجعة</div>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-purple-900/20 rounded-2xl p-6 border border-purple-800/30 text-center">
                <div className="text-3xl lg:text-4xl font-bold text-purple-400 mb-2">
                  {words.length > 0 ? 
                    (words.reduce((sum, w) => sum + w.easeFactor, 0) / words.length).toFixed(2) : 
                    '2.50'
                  }
                </div>
                <div className="text-sm lg:text-base text-gray-400 mb-2">متوسط عامل السهولة</div>
                <div className="text-xs text-gray-500">
                  {words.length > 0 ? 
                    (words.reduce((sum, w) => sum + w.easeFactor, 0) / words.length) >= 2.5 ? 
                      '✨ ممتاز' : 'قابل للتحسين' : 
                    'لا توجد بيانات'
                  }
                </div>
              ...
              <div className="bg-blue-900/20 rounded-2xl p-6 border border-blue-800/30 text-center">
                <div className="text-3xl lg:text-4xl font-bold text-blue-400 mb-2">
                  {words.length > 0 ? 
                    Math.round(words.reduce((sum, w) => sum + w.interval, 0) / words.length) : 
                    1
                  }
                </div>
                <div className="text-sm lg:text-base text-gray-400 mb-2">متوسط فترة المراجعة (أيام)</div>
                <div className="text-xs text-gray-500">
              ...
              <div className="bg-green-900/20 rounded-2xl p-6 border border-green-800/30 text-center">
                ...
                <div className="text-sm lg:text-base text-gray-400 mb-2">إجمالي التكرارات الناجحة</div>
                <div className="text-xs text-gray-500">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm lg:text-base">
                <div className="space-y-2">
                  <div className="flex items-start space-x-2">
                    ...
                    <span className="text-gray-300">تقييم صحيح (3-5): زيادة فترة المراجعة</span>
                  </div>
                  <div className="flex items-start space-x-2">
                    <span className="text-red-400 mt-1">✗</span>
                    <span className="text-gray-300">تقييم صعب (0-2): إعادة البداية</span>
                  </div>
                  <div className="flex items-start space-x-2">
                    <span className="text-blue-400 mt-1">⚡</span>
                    <span className="text-gray-300">عامل السهولة يتكيف مع أدائك</span>
                  </div>
                </div>
                <div className="space-y-2">
                  <div className="flex items-start space-x-2">
                    <span className="text-purple-400 mt-1">🎯</span>
                    <span className="text-gray-300">فترات مثلى: 1، 6، ثم مضاعفات ذكية</span>
                  </div>
                  <div className="flex items-start space-x-2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 mb-8 lg:mb-12">
            ...
            <div className="bg-gray-800 rounded-2xl lg:rounded-3xl p-6 lg:p-8 border border-gray-700">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h3 className="text-xl lg:text-2xl font-bold text-white">أداء التصنيفات</h3>
              </div>
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <div className="bg-gray-800 rounded-2xl p-6 border border-gray-700">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-sm text-gray-400">كلمات هذا الأسبوع</div>
                  </div>
              ...
              <div className="bg-gray-800 rounded-2xl p-6 border border-gray-700">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <h3 className="text-lg font-bold text-white">سلسلة المراجعة</h3>
                </div>
              ...
              <div className="bg-gray-800 rounded-2xl p-6 border border-gray-700">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <h3 className="text-lg font-bold text-white">المراجعة القادمة</h3>
                </div>
        ...
        <div className="space-y-8 lg:space-y-12">
          ...
          <div className="bg-gray-800 rounded-2xl lg:rounded-3xl p-6 lg:p-8 border border-gray-700">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <h3 className="text-xl lg:text-2xl font-bold text-white">تطور التعلم عبر الوقت</h3>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
            ...
            <div className="bg-gray-800 rounded-2xl lg:rounded-3xl p-6 lg:p-8 border border-gray-700">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h3 className="text-xl lg:text-2xl font-bold text-white">توزيع مستويات الصعوبة</h3>
              </div>
            ...
            <div className="bg-gray-800 rounded-2xl lg:rounded-3xl p-6 lg:p-8 border border-gray-700">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h3 className="text-xl lg:text-2xl font-bold text-white">مستويات الإتقان</h3>
              </div>
